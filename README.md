...
I work from real operating problems: accounting records, reconciliations, reporting, document flows, purchasing, inventory and the points where people lose time between systems. My background combines hands-on finance and commercial operations with product requirements, testing and workflow design.

## Current focus

- Accounting and ERP workflow prototypes
- Finance-process and document automation
- Operations systems with clear controls and auditability
- Read-only Solana tooling and selective open-source contributions
...
- [BountyProof x402 receipt verifier](https://github.com/AntonsBB/bountyproof-x402) -
...
1. Define the problem and acceptance checks before building.
2. Keep public claims tied to inspectable evidence.
